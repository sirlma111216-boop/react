...
현재 운영 배포: **https://react.labbitory.com** (커스텀 도메인, workers.dev: https://reaction-guild.sirlma.workers.dev) (계정 Sirlma@naver.com, Worker `reaction-guild`, 2026-09-25 `wrangler deploy` 로 배포·검증)
