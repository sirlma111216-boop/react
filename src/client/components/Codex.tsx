...
function Rules() {
  return (
    <div className="stack small" style={{ maxHeight: '60vh', overflow: 'auto' }}>
      ...
      <h3>주문·시세·입찰</h3>
      <p>주문은 팀당 2개까지. 배달할 때 받는 돈은 <b>기본금 ± 시세</b>(카테고리별, 최대 ±8%)이고 시세는 라운드가 바뀔 때만 움직여요. 지금 팔지, 다음 라운드에 팔지 고를 수 있어요. 3·6라운드에는 도시 특별 주문에 0~6코인을 몰래 써내서 가져가요(마무리 때 공개, 같은 금액이면 미리 정해진 순서).</p>
      <h3>정리하기</h3>
